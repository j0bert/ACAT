...
namespace WindowsFormsApplication1
{
    public partial class LearningOutcome : Form
    {
        ...
        private void NextButton_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < ABETLearningBox.CheckedIndices.Count; i++)
            {
                ABTmap.Add(MissionOBBox.CheckedIndices[i] + 1 + " ");
            }
            ...
            if (outcome.Count == outcomecount)
            {
                ...
                for (int j = 0; j <= outcome.Count - 1; j++)
                {
                    ...
                    worksheet.Cells[j + 2, 2] = MOresult;
                    worksheet.Cells[j + 2, 3] = ABTresult;
                    worksheet.Cells[j + 2, 4] = Assmresult;
                }
            }
